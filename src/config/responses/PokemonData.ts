// To parse this data:
//
//   import { Convert, DataPokemon } from "./file";
//
//   const dataPokemon = Convert.toDataPokemon(json);
//
...
export class Convert {
    public static toDataPokemon(json: string): PokemonData {
        return cast(JSON.parse(json), r("DataPokemon"));
    }

    public static dataPokemonToJson(value: PokemonData): string {
        return JSON.stringify(uncast(value, r("DataPokemon")), null, 2);
    }
}
